# -*- coding: utf-8 -*-
"""Aktivasyon_Fonksiyonları_Karşılaştırması
...
*   Swish Fonksiyonu
Aktivasyon fonksiyonlarının aynı veri seti ve derin öğrenme modeli için elde ettikleri doğrulama başarısı ve yitimi, eğitim başarısı ve yitimi hesaplanmaktadır. 
